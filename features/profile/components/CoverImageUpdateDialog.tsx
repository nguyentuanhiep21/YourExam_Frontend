...
export function CoverImageUpdateDialog({ isOpen, onClose, userId, onCoverUpdated }: CoverImageUpdateDialogProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col m-4 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <h2 className="text-lg font-semibold font-heading text-slate-900">Cập nhật ảnh bìa</h2>
          <button 
            onClick={handleClose}
